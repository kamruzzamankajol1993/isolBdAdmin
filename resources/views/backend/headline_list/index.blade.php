...
<div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="float-right d-md-block">
                                <div class="dropdown">
                                @if (Auth::guard('admin')->user()->can('special_news_add'))
...
{{-- <td>{!! $user->des !!}</td> --}}
                                    ...
                                    <td>
                                      @if (Auth::guard('admin')->user()->can('special_news_update'))
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="custom-validation" action="{{ route('admin.special_news_info.update') }}" method="post" enctype="multipart/form-data">
                              @csrf
                                <div class="row">
...
@endif
                                  ...
                                  @if (Auth::guard('admin')->user()->can('special_news_delete'))
...
<button   type="button" class="btn btn-danger waves-light waves-effect  btn-sm" onclick="deleteTag({{ $user->id}})" data-toggle="tooltip" title="Delete"><i class="fas fa-trash-alt"></i></button>
                    <form id="delete-form-{{ $user->id }}" action="{{ route('admin.special_news_info.delete',$user->id) }}" method="POST" style="display: none;">
...
<div class="modal fade bs-example-modal-lg456" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="custom-validation" action="{{ route('admin.special_news_info.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                       <div class="row">
