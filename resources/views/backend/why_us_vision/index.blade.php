                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if(count($why_us_vision_list) == 1)

                                    @foreach($why_us_vision_list as $all_back_video)

 <form class="custom-validation" action="{{ route('admin.why_us_vision.update') }}" method="post" enctype="multipart/form-data">
    @csrf
...
@endforeach
                                    @else
                                    <form class="custom-validation" action="{{ route('admin.why_us_vision.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                           <div class="row">
...
<th>title</th>
            ...
            <td>{{$user->title }}</td>
                ...
                <td>
                  @if (Auth::guard('admin')->user()->can('fourth_row_update'))
...
<h5 class="modal-title" id="exampleModalLabel">Update Vision Information</h5>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
</button>
</div>
<div class="modal-body">
<form class="custom-validation" action="{{ route('admin.fourth_row_info.update') }}" method="post" enctype="multipart/form-data">
          @csrf
            <div class="row">
...
@endif
              ...
              @if (Auth::guard('admin')->user()->can('fourth_row_delete'))
...
<form id="delete-form-{{ $user->id }}" action="{{ route('admin.fourth_row_info.delete',$user->id) }}" method="POST" style="display: none;">
...
<div class="modal-content">
<div class="modal-header">
<h5 class="modal-title" id="myLargeModalLabel">Add Vision Information</h5>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
</button>
</div>
<div class="modal-body">
<form class="custom-validation" action="{{ route('admin.fourth_row_info.store') }}" method="post" enctype="multipart/form-data">
@csrf
   <div class="row">
...
<input type="hidden" class="form-control form-control-sm" value="1" name="status" placeholder="Enter Title">
</div>
