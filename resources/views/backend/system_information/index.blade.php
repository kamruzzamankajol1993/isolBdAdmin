...
<div class="form-group col-md-6 col-sm-12">
                     ...
                     <input type="text" class="form-control form-control-sm" value="{{ $user->Address }}" name="Address" placeholder="Enter Address">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6 col-sm-12">
                                                        <label for="name">Front Url</label>
                                                        <input type="tex" class="form-control form-control-sm" value="{{ $user->frontUrl }}" name="frontUrl" placeholder="Enter Email">
                                                    </div>
