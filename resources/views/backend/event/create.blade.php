                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form  action="{{ route('eventList.store') }}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
                                        @csrf
                                           <div class="row">
                                              ...
                                              <div class="col-lg-12">
                                                  ...
                                                  <div class="row mt-3">
                                                    ...
                                                    <div class="form-group col-md-6 col-sm-12">
                                                        ...
                                                        <input type="text" required class="form-control form-control-sm " name="title"/>
                                                    ...
                                                    <div class="form-group col-md-6 col-sm-12">
                                                        ...
                                                        <input type="text" required class="form-control form-control-sm datepicker" name="date"/>
                                                    ...
                                                    <div class="form-group col-md-6 col-sm-12">
                                                        ...
                                                        <input type="text" required class="form-control form-control-sm" name="time"/>
                                                    ...
                                                    <div class="form-group col-md-6 col-sm-12">
                                                        ...
                                                        <input type="text" required class="form-control form-control-sm " name="speaker"/>
