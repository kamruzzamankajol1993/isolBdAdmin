...
<th>title</th>
                                        ...
                                        <tbody>
                                            @foreach ($eight_row_list as $user)
...
<td>{!! $user->des !!}</td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="custom-validation" action="{{ route('admin.eight_row_info.update') }}" method="post" enctype="multipart/form-data">
                              @csrf
                                <div class="row">
...
<button   type="button" class="btn btn-danger waves-light waves-effect  btn-sm" onclick="deleteTag({{ $user->id}})" data-toggle="tooltip" title="Delete"><i class="fas fa-trash-alt"></i></button>
                    <form id="delete-form-{{ $user->id }}" action="{{ route('admin.eight_row_info.delete',$user->id) }}" method="POST" style="display: none;">
...
<div class="modal fade bs-example-modal-lg456" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="custom-validation" action="{{ route('admin.eight_row_info.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                       <div class="row">
