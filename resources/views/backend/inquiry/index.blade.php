                                        ...
                                        <tr>
                                           ...
                                           <td>{{$user->mobile_number }}</td>
                                            ...
                                            <td>
                                                     ...
                                                     @if (Auth::guard('admin')->user()->can('inquiryListUpdate'))
...
@endif
                                          ...
                                          @if (Auth::guard('admin')->user()->can('inquiryListDelete'))
        ...
        <button   type="button" class="btn btn-danger waves-light waves-effect  btn-sm" onclick="deleteTag({{ $user->id}})" data-toggle="tooltip" title="Delete"><i class="fas fa-trash-alt"></i></button>
                            <form id="delete-form-{{ $user->id }}" action="{{ route('inquiryList.destroy',$user->id) }}" method="POST" style="display: none;">
