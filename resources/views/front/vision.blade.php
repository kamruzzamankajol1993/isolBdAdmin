            ...
            <div class="row ">
                <div class="col-lg-12 d-flex flex-column justify-content-center inquiry-content">
                    ...
                    <div class="mission_statement">
                        <ul>
                            <li>To continue as the most innovative, dynamic and passionate organization within
                                the Global Marine Industry, and
                            </li>
                            <li>To ensure an unparalleled quality service to the Cruise Liner Industry.</li>
                        </ul>
                    </div>
