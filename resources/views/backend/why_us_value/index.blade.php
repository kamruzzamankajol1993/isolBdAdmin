                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if(count($why_us_values_list) == 1)

                                    @foreach($why_us_values_list as $all_back_video)
...
<h5 class="modal-title" id="exampleModalLabel">Update Value Information</h5>
...
<div class="modal-content">
<div class="modal-header">
<h5 class="modal-title" id="myLargeModalLabel">Add Value Information</h5>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
</button>
</div>
<div class="modal-body">
...
<input type="hidden" class="form-control form-control-sm" value="2" name="status" placeholder="Enter Title">
</div>
