...
@section('title')
Appointment & Meeting List| {{ $ins_name }}
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Appointment & Meeting List</h4>
                                ...
                                <div class="card-body">
                                   ...
                                   <div class="table-responsive">
                                        ...
                                        <tr>
                                           ...
                                           <td>
                                               <a target="_blank" class="btn btn-primary btn-sm" href="{{route('scheduleDownloadCv',$user->id)}}">Download Cv</a>
                                           </td>
                                          

                                            <td>
                                                
                                                     @if (Auth::guard('admin')->user()->can('mScheduleListUpdate'))
...
@endif
                                          ...
                                          @if (Auth::guard('admin')->user()->can('mScheduleListDelete'))
        ...
        <button   type="button" class="btn btn-danger waves-light waves-effect  btn-sm" onclick="deleteTag({{ $user->id}})" data-toggle="tooltip" title="Delete"><i class="fas fa-trash-alt"></i></button>
                            <form id="delete-form-{{ $user->id }}" action="{{ route('mScheduleList.destroy',$user->id) }}" method="POST" style="display: none;">
