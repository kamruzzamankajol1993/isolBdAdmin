...
<li class="{{ Route::is('dreamJobSectorList.index') ? 'active' : '' }}">
    <a href="{{ route('dreamJobSectorList.index') }}">
       
        <span>Vacancy Sector</span>
    </a>
</li>
<li class="{{ Route::is('vesselOrWorkPlaceList.index') ? 'active' : '' }}">
    <a href="{{ route('vesselOrWorkPlaceList.index') }}">   
        <span>Vessel Or Work Place</span>
    </a>
</li> 
<li class="{{ Route::is('dreamJobDepartmentList.index') ? 'active' : '' }}">
    <a href="{{ route('dreamJobDepartmentList.index') }}">
       
        <span>Vacancy Department</span>
    </a>
</li>   
<li class="{{ Route::is('dreamJobPositionList.index') ? 'active' : '' }}">
    <a href="{{ route('dreamJobPositionList.index') }}">
